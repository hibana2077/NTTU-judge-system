...
LastEditTime: 2024-04-17 00:28:46
...
if __name__ == '__main__':
    ...
    if command == "startup":
        ...
        data['services'][f"mariadb_{object_name}"]['volumes'] = [f"./mariadb_{object_name}:/var/lib/mysql"]
        ...
        data['services'][f'domserver_{object_name}']['privileged'] = True
        data['services'][f'domserver_{object_name}']['user'] = "root"
